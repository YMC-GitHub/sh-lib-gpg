...
# set tpl
# run gen
gpg_id_get_by_name_and_mail "$GPG_USER_NAME" "$GPG_USER_EMAIL" > /dev/null 2>&1 ; [ -z "$GPG_USER_ID" ] && gpg_sec_key_gen "$GPG_CNF_KEY_FILE"
...
# sample/tom/app.add.sh "yemiancheng" "hualei03042013@163.com" "20-09-20" "$GPG_PASSPHRASE" "1y"
# sample/tom/app.add.sh "yemiancheng" "ymc.github@gmail.com" "19-06-30" "yemiancheng521" "2y"
# sample/tom/app.add.sh "$GPG_USER_NAME" "$GPG_USER_EMAIL" "$GPG_USER_NOTE" "$GPG_PASSPHRASE" "$GPG_KEY_EXP"